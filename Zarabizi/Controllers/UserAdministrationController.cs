...
using MvcMembership;
using Zarabizi.Models.UserAdministration;
...
namespace Zarabizi.Controllers
{
	...
	public class UserAdministrationController : Controller
	{
		...
		private const string ResetPasswordSubject = "Su nueva contraseña";
		...
		public ViewResult Index(int? index)
		{
			...
			if(roles.Distinct().Count() != roles.Count())
				throw new DuplicateRoleException("La lista de roles contiene duplicados.");
