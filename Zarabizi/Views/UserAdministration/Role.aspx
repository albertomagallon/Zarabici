<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Zarabizi.Models.UserAdministration.RoleViewModel>" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="mvcMembership-roleUsers">
		...
		<% }else{ %>
		<p>No hay usuarios en éste rol.</p>
		<% } %>
	</div>
